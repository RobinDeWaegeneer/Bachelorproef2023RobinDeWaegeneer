...
% TODO: omschrijf duidelijk de populatie van de enquête en hoe je de steekproef opgesteld hebt (je geeft hier wel al goed de aantallen aan)
% TODO: moet dit nog nagelezen worden op taal? Het lijkt me dat er nog wat aanpassingen nodig zijn.
% TODO: probeer het meer op te delen in secties, deze tekst leest niet zo vlot omdat het één grote blok is. Je kan secties maken o.b.v. de vragen die je gesteld hebt, o.b.v. grote thema's in de enquête...
...
Om de juiste keuzes te implementeren tijdens dit onderzoek is een online enquête uitgevoerd bij diverse stakeholders (ouders, mantelzorgers, (thuis)begeleiders, (paramedische) leerkrachten, vrienden) die in min of meerdere mate betrokken zijn bij de doelgroep.
