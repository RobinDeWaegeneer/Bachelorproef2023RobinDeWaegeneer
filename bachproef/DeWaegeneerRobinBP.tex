...
\usepackage[section,outputdir=./out]{minted}
\usepackage{biblatex}
\usepackage{hyperref}
\usepackage{graphicx}
\usepackage{url}
...
% TODO: JavaScript word niet ondersteund (zie https://en.wikibooks.org/wiki/LaTeX/Source_Code_Listings#Supported_languages)
