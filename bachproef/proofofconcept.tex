...
% TODO: voeg een url toe naar installatie instructies voor Node.js
% TODO: die Google Play API key heb je hieronder niet vermeldt in de inleiding. Hebben we die effectief nog nodig? De instructies om ze te verkrijgen moeten in de inleiding, de aanpassing van de code hieronder. Voeg ook een link voor de publieke token van Mapbox toe.
...
% TODO: geen secties zonder korte inleiding ervoor! Misschien kan je hierin vermelden hoe je aan bepaalde informatie gekomen bent?
...
% TODO: misschien vermelden tussen welke prijsklassen de verschillende plannen van Mapbox zich bevinden?
...
% TODO: geen secties zonder korte inleiding ervoor!
