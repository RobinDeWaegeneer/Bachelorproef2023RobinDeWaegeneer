...
Mapbox biedt flexibele prijsmodellen\footnote{\url{https://www.mapbox.com/pricing}}, waaronder een gratis versie voor basisgebruik en schaalbare betalingsopties voor geavanceerdere toepassingen. Dit kan gezien worden onder de naam pay-as-you-go wat wilt zeggen er betaald wordt voor wat er effectief gebruikt, daarop is het prijsmodel van Mapbox gebaseerd. Dit maakt het mogelijk om kostenefficiënte navigatieoplossingen te implementeren die aansluiten bij de behoeften en budgetten van verschillende gebruikers. 
